    ...
    try {
      const res = await fetch('https://openrouter.ai/api/v1/chat/completions', {
        ...
        body: JSON.stringify({
          ...
          messages: [
            { role: 'system', content: selectedAssociation.systemPromptContent },
        ...
        <form onSubmit={handleSubmit}>
          ...
          {selectedAssociation && (
            <div className="mb-3 p-3 rounded" style={{ background: '#23272b', border: '1px solid #454d55' }}>
              ...
              <div><strong>Prompt système :</strong> <span style={{ fontStyle: 'italic' }}>{selectedAssociation.systemPromptContent}</span></div>
            </div>
          )}
          <div className="mb-3">
